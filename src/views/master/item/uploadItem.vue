  ...
  <CCard class="mb-4">
    ...
    <CCardBody>
      <CForm @submit.prevent="save">
          ...
          <CCard>
            <CCardHeader>Import Data</CCardHeader>
            <CCardBody>
              <div class="mb-3">
...
const uploadFile = () => {
  if (selectedFile.value) {
      ...
      formData.append('uploads', selectedFile.value);  // Menambahkan file ke FormData
      formData.append('')

      axios.post('/api/import_tools/items/excels', formData, {
        headers: {
      ...
      .then(response => {
        ...
        console.log(response.data); // Menangani response dari backend
      })
      .catch(error => {
